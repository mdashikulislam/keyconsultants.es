    ...
    <div class="row">
        <div class="col-md-12">
            <div class="note text-right" style="margin-right: 30px;">
                <button data-toggle="modal" data-target="#add_owner" type="button" class="btn btn-info"><i class="fa fa-plus fa-fw"></i>Add Owner</button>
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 d-flex align-items-stretch flex-column">
                    <div class="card bg-light d-flex flex-fill">
                        <div class="card-footer text-muted border-bottom-0" style="padding: 8px 0">
                ...
                <!-- timeline time label -->
                    ...
                    <div>
                        ...
                        <div class="timeline-item">
                            <span class="time"><i class="fas fa-envelope fa-fw"></i> {{$note->email}}</span>
                            <h3 class="timeline-header">Name : {{$note->name}}</h3>
        ...
        <div class="modal fade" id="add_note"  style=" padding-right: 17px;" aria-modal="true" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{route('admin.note.add')}}" method="POST">
                        @csrf
        ...
        <div class="modal fade" id="add_owner"  style=" padding-right: 17px;" aria-modal="true" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{route('owner.store')}}" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="">DNI/NIE Number</label>
                                <input name="dni_nie" type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="">Address(1)</label>
                                <textarea name="address1" rows="2" class="form-control" ></textarea>
                            </div>
                            <div class="form-group">
                                <label for="">Address(2)</label>
                                <textarea name="address2" rows="2" class="form-control" ></textarea>
                            </div>
                            <div class="form-group">
                                <label for="">Country</label>
                                <select style="width: 100%;height: 50px!important;" id="country" name="country" class="form-control select2">
...
@push('js')
    ...
    <script>
        ...
        function deleteNote(id){
            ...
            var url = '{{route('admin.note.delete',['id'=>':id'])}}';
