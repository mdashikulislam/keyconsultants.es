                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="owner_name" value="{{$property->owner_name ? :old('owner_name')}}" class="form-control @error('owner_name') is-invalid @enderror">
                            @error('owner_name')
                            <span class="invalid-feedback">{{$message}}</span>
                            @enderror
                        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-6">
                                <label for="">IBI</label>
                                <input value="{{$property->ibi}}" name="ibi" type="number" class="form-control">
                            </div>
                            <div class="form-group col-6">
                                <label for="">Basura</label>
                                <input value="{{$property->basura}}" name="basura" type="number" class="form-control">
                            </div>
                            <div class="form-group col-6">
